...
root = MinHeapNode(1)
root.left = MinHeapNode(2)
root.right = MinHeapNode(3)
root.left.left = MinHeapNode(4)
root.left.right = MinHeapNode(5)
root.right.left = MinHeapNode(6)
root.right.right = MinHeapNode(7)
